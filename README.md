...
=> 'c'
```
### [(Solve the problem on codewars)](https://www.codewars.com/kata/5971b219d5db74843a000052/train/javascript)
...
### P19- Convert string to camel case
...
```
### [(Solve this problem on codewars)](https://www.codewars.com/kata/517abf86da9663f1d2000003/train/javascript)

**Solution:**
```
function toCamelCase(str){
  return str.split(/[^a-zA-Z0-9]+/).map((word, index)=>{
    if(index === 0){
